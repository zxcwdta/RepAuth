...
public class ElGamalKeyPairGenerator extends KeyPairGeneratorSpi implements CipherConstants
{
	...
	public KeyPair generateKeyPair() 
	{
		...
		ElGamalPrivateKey sk = new ElGamalPrivateKey(p, x, g, h, q, ADDITIVE);
		ElGamalPublicKey pk = new ElGamalPublicKey(p, g, h, q, ADDITIVE);
		if (ADDITIVE)
		{
	...
	public KeyPair generateKeyPair(BigInteger g, BigInteger p) 
	{
		long start_time = -1;
		if(this.random == null)
		{
